...
const calculateHeightFromDistanceHorizontal = (distanceFromWall:number): number => {
...
export {calculateHeightFromDistanceHorizontal, calculateDistanceFromHeightHorizontal}