...
export function UserSettingsSignedIn() {
  ...
  return (
    <ScrollView style={{height: hp('100%')}}>
      ...
      <GlobalText style={SSSignedInUserSettings.header}>
        profile picture
      </GlobalText>
      ...
      <Animated.View
        ...
        <View
          ...
          <GlobalText style={[SSSignedInUserSettings.header, {height: 'auto'}]}>
            user name
          </GlobalText>
          <View style={SSSignedInUserSettings.textEditContainer}>
            <View style={{width: wp('60%')}}>
              {formData.userName.isEditing ? (
                ...
                <GlobalText style={SSSignedInUserSettings.text}>
      ...
      <Animated.View
        ...
        <View
          ...
          <GlobalText style={SSSignedInUserSettings.header}>name</GlobalText>
          <View style={SSSignedInUserSettings.textEditContainer}>
            <View style={{width: wp('60%')}}>
      ...
      <Animated.View style={!formData.email.isEditing && {height: heightAnim}}>
        ...
        <View
          ...
          <GlobalText style={SSSignedInUserSettings.header}>email</GlobalText>
          <View style={SSSignedInUserSettings.textEditContainer}>
            <View style={{width: wp('60%')}}>
      ...
      <Animated.View style={!formData.phone.isEditing && {height: heightAnim}}>
        ...
        <View
          ...
          <GlobalText style={SSSignedInUserSettings.header}>phone</GlobalText>
          <View style={SSSignedInUserSettings.textEditContainer}>
            <View style={{width: wp('60%')}}>
