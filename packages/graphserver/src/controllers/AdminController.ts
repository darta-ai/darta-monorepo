...
export class AdminController {
  ...
  public async validateCollection(@request() req: Request, @response() res: Response): Promise<void> {
    try {
  ...
  public async galleryApproval(@request() req: Request, @response() res: Response): Promise<void> {
    const approvedURL = req.body.approvedURL
    try {
