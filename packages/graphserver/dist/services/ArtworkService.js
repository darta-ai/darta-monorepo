...
let ArtworkService = exports.ArtworkService = class ArtworkService {
      ...
      `;
            ...
            try {
                const createArtworkCursor = yield this.db.query(artworkQuery, {
                    newArtwork: Object.assign(Object.assign({}, artwork), { _key: artwork.artworkId, galleryId }),
                });
    ...
    getArtworkById(artworkId) {
      ...
      `;
            ...
            if ((artworkImage === null || artworkImage === void 0 ? void 0 : artworkImage.bucketName) && (artworkImage === null || artworkImage === void 0 ? void 0 : artworkImage.fileName)) {
                try {
                    artworkImageValue = yield this.imageController.processGetFile({
                        fileName: artworkImage.fileName,
                        bucketName: artworkImage.bucketName,
                    });
                }
            ...
            return Object.assign(Object.assign({}, artwork), { artworkMedium: {
                ...
                }, artworkImage: Object.assign(Object.assign({}, artworkImage), { value: artworkImageValue }) });
        });
    }
