...
const arangoContainer = container
    .bind(TYPES.Database)
    .toConstantValue(new arangojs_1.Database({
...
const minioContainer = container
    .bind(TYPES.MinioClient)
    .toConstantValue(new minio_1.Client({
    endPoint: config_1.config.minio.endpoint,
    port: parseInt(config_1.config.minio.port, 10),
