    ...
    <Box mb={2} sx={createArtworkStyles.container}>
      ...
      <Box>
        <Box
          ...
          <Box sx={createArtworkStyles.imageContainerExhibitions}>
            <Box>
              {editPressRelease ? (
                <DartaImageInput
                  onDrop={handleDrop}
          ...
          <Box sx={{width: '30vw', alignSelf: 'center'}}>
            <Button
              sx={{width: '30vw'}}
      ...
      <Box sx={createArtworkStyles.dimensionsAndPricingContainer}>
        <Box
          sx={{
      ...
      <Box sx={createArtworkStyles.dimensionsAndPricingContainer}>
        <Box sx={createArtworkStyles.inputText}>
          <Box key="pricing" sx={createArtworkStyles.inputTextContainer}>
      ...
      <Box sx={createArtworkStyles.dimensionsAndPricingContainer}>
        <Box key="dates" sx={createArtworkStyles.inputText}>
