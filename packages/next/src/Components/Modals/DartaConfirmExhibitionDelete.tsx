  ...
  return (
    <Dialog
      ...
      <DialogTitle id="alert-dialog-title">
        <Typography sx={{fontWeight: 'bold'}} variant="h5">{`Do you want to delete both the artwork and the exhibition from darta?`}</Typography>
      </DialogTitle>
      <DialogContent>
      ...
      {isSpinner ? (
        ...
        <Button
          ...
          autoFocus>
          <Typography sx={{fontWeight: 'bold'}}>Delete Exhibition</Typography>
        </Button>
        <Button
          variant="contained"
          color="error"
          ...
          autoFocus>
            <Typography sx={{fontWeight: 'bold'}}>Delete Exhibition and Artwork</Typography>
        </Button>
        </>
        )
      }
