  ...
  return (
    <Dialog
      ...
      <DialogTitle id="alert-dialog-title">
        <Typography sx={{fontWeight: 'bold'}} variant="h5">{`Do you want to delete the artwork from darta?`}</Typography>
      </DialogTitle>
      <DialogContent>
        <DialogContentText id="alert-dialog-description-1">
          <Typography sx={{fontWeight: 'bold'}}>Please indicate if you would like to delete the artwork OR remove it from the exhibition.</Typography>
        </DialogContentText>
        <DialogContentText id="alert-dialog-description-2">
          <Typography sx={{fontWeight: 'bold'}}>By keeping the artwork on darta will increase the views of the artwork and your gallery.</Typography>
        </DialogContentText>
      ...
      <DialogActions>
        ...
        <Button
          ...
          autoFocus>
          <Typography sx={{fontWeight: 'bold'}}>Remove From Exhibition</Typography>
        </Button>
        <Button
          variant="contained"
          color="error"
          ...
          autoFocus>
            <Typography sx={{fontWeight: 'bold'}}>Delete Artwork From Darta</Typography>
        </Button>
        </>
        )}
