...
export function GalleryLocationComponent({
  ...
  const galleryCity = galleryLocationData?.city?.value ?? galleryLocationArray?.slice(1, 2);
            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={1.5}>
                <Typography
                  ...
                  {hoursOfOperation?.Monday.open.value === "Closed" ? "-" : hoursOfOperation?.Monday.open.value }
                </Typography>
              </Grid>
              <Grid item xs={1.5}>
                <Typography
                  ...
                  {hoursOfOperation?.Tuesday.open.value === "Closed" ? "-" : hoursOfOperation?.Tuesday.open.value }
                </Typography>
              </Grid>
              <Grid item xs={1.5}>
                <Typography
                  ...
                  {hoursOfOperation?.Wednesday.open.value === "Closed" ? "-" : hoursOfOperation?.Wednesday.open.value }
                </Typography>
              </Grid> 
              <Grid item xs={1.5}>
                <Typography
                  ...
                  {hoursOfOperation?.Thursday.open.value === "Closed" ? "-" : hoursOfOperation?.Thursday.open.value }
                </Typography>
              </Grid>
              <Grid item xs={1.5}>
                <Typography
                  ...
                  {hoursOfOperation?.Friday.open.value === "Closed" ? "-" : hoursOfOperation?.Friday.open.value }
                </Typography>
              </Grid>
              <Grid item xs={1.5}>
                <Typography
                  ...
                  {hoursOfOperation?.Saturday.open.value === "Closed" ? "-" : hoursOfOperation?.Saturday.open.value }
                </Typography>
              </Grid>
              <Grid item xs={1.5}>
                <Typography
                  ...
                  {hoursOfOperation?.Sunday.open.value === "Closed" ? "-" : hoursOfOperation?.Sunday.open.value }
                </Typography>
              </Grid>
              <Grid item xs={1.5}>
                <Typography
              ...
              <Grid item xs={1.5}>
                <Typography
                  ...
                  {hoursOfOperation?.Monday.close.value === "Closed" ? "-" : hoursOfOperation?.Monday.close.value }
                </Typography>
              </Grid>
              ...
              <Grid item xs={1.5}>
                <Typography
                  ...
                  {hoursOfOperation?.Tuesday.close.value === "Closed" ? "-" : hoursOfOperation?.Tuesday.close.value }
                </Typography>
              </Grid>
              ...
              <Grid item xs={1.5}>
                <Typography
                  ...
                  {hoursOfOperation?.Wednesday.close.value === "Closed" ? "-" : hoursOfOperation?.Wednesday.close.value }
                </Typography>
              </Grid>
              ...
              <Grid item xs={1.5}>
                <Typography
                  ...
                  {hoursOfOperation?.Thursday.close.value === "Closed" ? "-" : hoursOfOperation?.Thursday.close.value }
                </Typography>
              </Grid>
              ...
              <Grid item xs={1.5}>
                <Typography
                  ...
                  {hoursOfOperation?.Friday.close.value === "Closed" ? "-" : hoursOfOperation?.Friday.close.value }
                </Typography>
              </Grid>
              ...
              <Grid item xs={1.5}>
                <Typography
                  ...
                  {hoursOfOperation?.Saturday.close.value === "Closed" ? "-" : hoursOfOperation?.Saturday.close.value }
                </Typography>
              </Grid>
              ...
              <Grid item xs={1.5}>
                <Typography
                  ...
                  {hoursOfOperation?.Sunday.close.value === "Closed" ? "-" : hoursOfOperation?.Sunday.close.value }
                </Typography>
              </Grid>
            </Grid>
          </>
